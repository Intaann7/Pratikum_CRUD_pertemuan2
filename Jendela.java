 ...
 * @author Lenovo
 */
public class Jendela extends javax.swing.JFrame {
    List<Mahasiswa> mahasiswa = new ArrayList<Mahasiswa>();
    int currentRow = 0;


    /**
     * Creates new form Jendela
     */
    public Jendela() {
    ...
    private void initComponents() {
        ...
        txtTmpLahir.setText("jTextField3");
        ...
        txtAsalSekolah.setText("jTextField5");

        jLabel7.setText("/");

        txtTglLahir.setText("jTextField6");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jendela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
